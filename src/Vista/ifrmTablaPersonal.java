...
public class ifrmTablaPersonal extends javax.swing.JInternalFrame {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (cargo != 0) {
            try {
                ...
                Date fechaNac = dateFormat1.parse(fechaNacimiento);
                System.out.println("Hasta aqui 4");
                Date fechaIn = dateFormat2.parse(fechaIngreso);
                Date fechaSal = dateFormat3.parse(fechaSalida);
                System.out.println("Hasta aqui 3");
    ...
    //////////////// EVENTO PARA ENVIAR LOS VALORES DE LA TABLA A LOS CAMPOS ////////////////
    private void tableDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDatosMouseClicked
        ...
        if (filas == -1) {
            ...
            switch (idCargo) {
                case "1":
                    id_Cargo = "Director Sistemas Administrativos"; break;
                case "2":
                    id_Cargo = "Asistente Social"; break;
                case "3":
                    id_Cargo = "Planificador"; break;
                case "4":
                    id_Cargo = "Abogado"; break;
                case "5":
                    id_Cargo = "Especialista administrativo"; break;
                case "6":
                    id_Cargo = "Ingeniero"; break;
                case "7":
                    id_Cargo = "Estadistico"; break;
                case "8":
                    id_Cargo = "Secretaria"; break;
                case "9":
                    id_Cargo = "Tecnico Administrativo"; break;
                case "10":
                    id_Cargo = "Chofer"; break;
                case "11":
                    id_Cargo = "Programador sistema pad"; break;
                case "12":
                    id_Cargo = "Trabajador de servicio"; break;
            }
            ...
            try {
                ...
                e.printStackTrace();
            }// Fin de la devolucion al DataChooser
    ...
    public void registrar(Personal personal) {
        ...
        try {
            ...
            String fechaInTexto = dateFormat2.format(fechaIngreso);
            ps.setString(16, fechaInTexto);
            Date fechaSalida = personal.getFecha_salida();
            SimpleDateFormat dateFormat3 = new SimpleDateFormat("yyy/MM/dd");
            String fechaSalTexto = dateFormat3.format(fechaSalida);
    ...
    //=============== METODO PARA MOSTRAR TODOS LOS VALORES DE LA BASE DE DATOS EN LA TABLA ===============//
